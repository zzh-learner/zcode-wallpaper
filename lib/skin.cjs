...
var DECORATION_EMOJI_POSITIONS = ["top-left", "top-right", "bottom-left", "bottom-right"];
  ...
  return [
    {
      ...
      font: null, radius: 16,
      decorations: { brand: "粉紫梦境", sparkle: true, emojiBadge: "♡", emojiPosition: "top-left" }
    },
    {
      ...
      font: null, radius: 12,
      decorations: { brand: "暗夜金", sparkle: true, emojiBadge: "✦", emojiPosition: "top-right" }
    },
    {
      ...
      font: null, radius: 10,
      decorations: { brand: null, sparkle: false, emojiBadge: null, emojiPosition: "top-left" }
    }
  ];
}
