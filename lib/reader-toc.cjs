...
//
// NOTE: '两' is a common Chinese numeral (两千 = 二千). Without it, headings
// like "第两千章" are NOT matched — real sample (凡人修仙传) lost 447 chapters
// (2000..2446 all use 第两千…) because 两 was missing from the char class.
